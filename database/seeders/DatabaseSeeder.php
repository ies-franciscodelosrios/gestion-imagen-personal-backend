    ...
    public function run()
    {
        ...
        DB::table('users')->insert([
            [
                ...
                'rol' => 0,
                'course_year' => now(),
                'cycle' => 'Grado Medio - Peluquería y cosmética capilar',
                'name' => 'Administrador',
                'surname' => 'root',
                ...
                'rol' => 1,
                'course_year' => now(),
                'cycle' => 'Grado Superior - Estética integral y bienestar',
                'name' => 'Josefina',
                'surname' => 'Guitierrez',
                ...
                'rol' => 1,
                'course_year' => now(),
                'cycle' => 'Grado Superior - Estilismo y dirección de peluquería',
                'name' => 'Pedro',
                'surname' => 'Sanchez',
